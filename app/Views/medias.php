...
<div class="content-wrapper">
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Manage Other Media</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">Manage Other Media</h3>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <input type="file" class="form-control" placeholder="Please input video link *" value=""
                            required="required" />
                    </div>
    ...
    <section class="content" style="margin-left: 2px;">
        <div class="container-fluid">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">List of Other Media</h3>
                    <div class="card-tools">
                        <button type="button" class="btn btn-tool" data-card-widget="collapse">
                            <i class="fas fa-minus"></i>
                        </button>
